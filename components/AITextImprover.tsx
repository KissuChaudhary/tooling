...
/>
      ...
      <div className="flex flex-col md:flex-row gap-8">
        <Card className="w-full md:w-1/2">
          <CardHeader>
            <CardTitle>Text Improvement Details</CardTitle>
          </CardHeader>
          <CardContent>
                ...
                <div key={field} className="relative">
                  <div className="flex justify-between items-center mb-1">
                    <Label htmlFor={field} className="text-sm font-medium text-gray-400 capitalize">
                      {field === 'originalText' ? 'Original Text' : 'Improvement Goal'}
                    </Label>
                  ...
                  {field === 'originalText' ? (
                    ...
                    <Input
                      ...
                      value={formData[field]}
                      onChange={(e) => handleChange(field, e.target.value)}
                      placeholder="Enter your improvement goal..."
                      className={`mt-1 ${errors[field] ? 'border-red-500' : ''}`}
                    />
                  )}
                  {errors[field] && (
        ...
        <Card className="w-full md:w-1/2">
          ...
          <CardContent>
            {improvedText ? (
              <>
                <div className="bg-gray-100 p-4 rounded-md mb-4 h-[300px] overflow-y-auto">
              ...
              <p className="text-gray-500 italic">Your improved text will appear here.</p>
            )}
          </CardContent>
        </Card>
      </div>
