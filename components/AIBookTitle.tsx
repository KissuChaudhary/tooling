...
export default function BookTitleGenerator() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.error || 'An error occurred while generating book titles');
      }

      setGeneratedTitles(data.bookTitle);
    } catch (error) {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 mt-10">
      <h1 className="text-4xl font-extrabold mb-8 text-center tracking-tight">AI Book Title Generator</h1>
      <p className="text-xl text-center mb-12 max-w-3xl mx-auto">Generate Captivating Book Titles with Saze AI – Inspire Your Next Bestseller.</p>
      <AdUnit 
      ...
      <div className="flex flex-col md:flex-row gap-8">
        <Card className="w-full md:w-1/2">
          <CardHeader>
            <CardTitle>Book Title Parameters</CardTitle>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder="Enter the main theme of your book..."
              ...
              <div className="space-y-2">
                ...
                <Select onValueChange={handleAudienceChange}>
                  <SelectTrigger id="audience" className={errors.audience ? 'border-red-500' : ''}>
        ...
        <Card className="w-full md:w-1/2">
          <CardHeader>
            <CardTitle>Generated Book Titles</CardTitle>
          </CardHeader>
          <CardContent>
            {generatedTitles.length > 0 ? (
              ...
              <p className="text-gray-500 italic">Your generated book titles will appear here.</p>
            )}
          </CardContent>
        </Card>
      </div>
