...
interface FormData {
  ...
  targetGender: string;
  setting: string;
  style: 'smooth' | 'witty' | 'cheesy' | 'nerdy' | 'romantic' | 'funny' | 'clever' | 'geeky' | 'punny' | 'flirty';
}
...
export default function PickupLineGenerator() {
  ...
  const [generatedPickupLine, setGeneratedPickupLine] = useState<string>('');
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.targetGender) {
      newErrors.targetGender = 'Target gender is required';
    }
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText(generatedPickupLine);
    setCopied(true);
    ...
    <div className="max-w-7xl mx-auto p-4 mt-10">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        <Card className="w-full md:w-1/2">
          <CardHeader>
            <CardTitle>Pickup Line Parameters</CardTitle>
          </CardHeader>
          <CardContent>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder="Enter the target's name (optional)..."
                  />
                  <p className={`absolute right-0 -bottom-5 text-xs ${parseInt(characterCounts.targetName) === characterLimits.targetName ? 'text-orange-500' : 'text-gray-500'}`}>
                    {characterCounts.targetName}/{characterLimits.targetName}
                  </p>
                </div>
              </div>
              <div className="space-y-2">
                ...
                <Select onValueChange={(value) => handleInputChange('targetGender', value)}>
                  <SelectTrigger className={errors.targetGender ? 'border-red-500' : ''}>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder="Enter the setting (e.g., bar, coffee shop, library)..."
              ...
              <div className="space-y-2">
                ...
                <Select onValueChange={(value) => handleInputChange('style', value as FormData['style'])}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="geeky">Geeky</SelectItem>
                    <SelectItem value="punny">Punny</SelectItem>
        ...
        <Card className="w-full md:w-1/2">
          <CardHeader>
            <CardTitle>Generated Pickup Line</CardTitle>
          </CardHeader>
          <CardContent>
            {generatedPickupLine ? (
              <>
              ...
              <p className="text-gray-500 italic">Your generated pickup line will appear here.</p>
            )}
          </CardContent>
        </Card>
      </div>
