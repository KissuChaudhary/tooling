...
export default function PunctuationChecker() {
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Textarea
                    ...
                    placeholder="Paste your text here for punctuation checking..."
                    className={`resize-none ${errors.text ? 'border-red-500' : ''}`}
                    rows={10}
                  />
                  <p className={`absolute right-0 -bottom-5 text-xs ${parseInt(characterCounts.text) === characterLimits.text ? 'text-orange-500' : 'text-gray-500'}`}>
                    {characterCounts.text}/{characterLimits.text}
                  </p>
                </div>
                {errors.text && (
        ...
        <Card className="w-full md:w-1/2">
          ...
          <CardContent>
            {checkedText ? (
              ...
              <p className="text-gray-500 italic">Your checked text will appear here.</p>
            )}
          </CardContent>
        </Card>
      </div>
