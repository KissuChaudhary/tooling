    ...
    <div className="max-w-7xl mx-auto p-4 mt-10">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        <Card className="w-full md:w-1/2">
          <CardHeader>
            <CardTitle>Quote Parameters</CardTitle>
          </CardHeader>
          <CardContent>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder="Enter the quote topic (e.g., love, success, motivation)..."
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder="Describe the quote style (e.g., inspirational, humorous, philosophical)..."
            ...
            {generatedQuote ? (
              <>
                <div className="bg-gray-100 p-4 rounded-md mb-4 max-h-96 overflow-y-auto">
                  <p className="whitespace-pre-wrap">{generatedQuote}</p>
                </div>
              ...
              <p className="text-gray-500 italic">Your generated quote will appear here.</p>
            )}
          </CardContent>
        </Card>
      </div>
