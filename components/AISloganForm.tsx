    ...
    <div className="max-w-7xl mx-auto p-4 mt-10">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        <Card className="w-full md:w-1/2">
          <CardHeader>
            <CardTitle>Slogan Parameters</CardTitle>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  />
                  <p className={`absolute right-0 -bottom-5 text-xs ${parseInt(characterCounts.brand) === characterLimits.brand ? 'text-orange-500' : 'text-gray-500'}`}>
                    {characterCounts.brand}/{characterLimits.brand}
                  </p>
                </div>
                {errors.brand && (
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Textarea
                    ...
                    className={`resize-none ${errors.product ? 'border-red-500' : ''}`}
                    rows={3}
                  />
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Textarea
                    ...
                    className={`resize-none ${errors.targetAudience ? 'border-red-500' : ''}`}
                    rows={3}
                  />
        ...
        <Card className="w-full md:w-1/2">
          <CardHeader>
            <CardTitle>Generated Slogan</CardTitle>
          </CardHeader>
          <CardContent>
            {generatedSlogan ? (
              <>
                <div className="bg-gray-100 p-4 rounded-md mb-4 max-h-96 overflow-y-auto">
                  <p className="whitespace-pre-wrap text-lg font-semibold text-center">{generatedSlogan}</p>
                </div>
              ...
              <p className="text-gray-500 italic">Your generated slogan will appear here.</p>
            )}
          </CardContent>
        </Card>
      </div>
