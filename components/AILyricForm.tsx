...
export default function LyricGenerator() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.error || 'An error occurred while generating the lyrics');
      }
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 mt-10">
      <h1 className="text-4xl font-extrabold mb-8 text-center tracking-tight">AI Lyric Generator</h1>
      <p className="text-xl text-center mb-12 max-w-3xl mx-auto">Create Inspiring Lyrics with Saze AI – Bring Your Musical Ideas to Life.</p>
      <AdUnit 
      ...
      <div className="flex flex-col md:flex-row gap-8">
        <Card className="w-full md:w-1/2">
          <CardHeader>
            <CardTitle>Lyric Parameters</CardTitle>
          </CardHeader>
          <CardContent>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder="Enter the music genre (e.g., rock, pop, hip-hop)..."
                    className={errors.genre ? 'border-red-500' : ''}
                  />
                  <p className={`absolute right-0 -bottom-5 text-xs ${parseInt(characterCounts.genre) === characterLimits.genre ? 'text-orange-500' : 'text-gray-500'}`}>
                    {characterCounts.genre}/{characterLimits.genre}
                  </p>
                </div>
                {errors.genre && (
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder="Enter the main theme or topic of the lyrics..."
                    className={errors.theme ? 'border-red-500' : ''}
                  />
                  <p className={`absolute right-0 -bottom-5 text-xs ${parseInt(characterCounts.theme) === characterLimits.theme ? 'text-orange-500' : 'text-gray-500'}`}>
                    {characterCounts.theme}/{characterLimits.theme}
                  </p>
                </div>
                {errors.theme && (
                  <p className="mt-1 text-sm text-red-600 flex items-center">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder="Describe the desired mood (e.g., upbeat, melancholic, energetic)..."
        ...
        <Card className="w-full md:w-1/2">
          ...
          <CardContent>
            {generatedLyrics ? (
              ...
              <p className="text-gray-500 italic">Your generated lyrics will appear here.</p>
            )}
          </CardContent>
        </Card>
      </div>
