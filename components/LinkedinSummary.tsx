  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch('/api/openai-api', {
        ...
        body: JSON.stringify({
          tool: 'aiLinkedInSummaryGenerator',
          model,
          data: formData,
        }),
      });
...
/>
      ...
      <div className="flex flex-col md:flex-row gap-8">
        <Card className="w-full md:w-1/2">
          <CardHeader>
            <CardTitle>LinkedIn Summary Parameters</CardTitle>
          </CardHeader>
          <CardContent>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder="Enter your current profession or job title..."
                    className={errors.profession ? 'border-red-500' : ''}
                  />
                  <p className={`absolute right-0 -bottom-5 text-xs ${parseInt(characterCounts.profession) === characterLimits.profession ? 'text-orange-500' : 'text-gray-500'}`}>
                    {characterCounts.profession}/{characterLimits.profession}
                  </p>
                </div>
                {errors.profession && (
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Textarea
                    ...
                    placeholder="Highlight your notable professional achievements..."
                    className={`resize-none h-32 ${errors.achievements ? 'border-red-500' : ''}`}
                  />
                  <p className={`absolute right-0 -bottom-5 text-xs ${parseInt(characterCounts.achievements) === characterLimits.achievements ? 'text-orange-500' : 'text-gray-500'}`}>
                    {characterCounts.achievements}/{characterLimits.achievements}
                  </p>
                </div>
                {errors.achievements && (
                  <p className="mt-1 text-sm text-red-600 flex items-center">
        ...
        <Card className="w-full md:w-1/2">
          <CardHeader>
            <CardTitle>Generated LinkedIn Summary</CardTitle>
          </CardHeader>
          <CardContent>
            {generatedSummary ? (
              <>
