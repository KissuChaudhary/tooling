...
export default function PlotGenerator() {
  ...
  const [generatedPlot, setGeneratedPlot] = useState<string>('');
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.characters.trim()) {
      newErrors.characters = 'Characters are required';
    }
    setErrors(newErrors);
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder="Enter the story genre (e.g., mystery, romance, sci-fi)..."
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder="Describe the story setting (time period, location)..."
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Textarea
                    ...
                    placeholder="Describe the main characters (names, roles, traits)..."
                    className={`resize-none ${errors.characters ? 'border-red-500' : ''}`}
                    rows={3}
                  />
                  <p className={`absolute right-0 -bottom-5 text-xs ${parseInt(characterCounts.characters) === characterLimits.characters ? 'text-orange-500' : 'text-gray-500'}`}>
                    {characterCounts.characters}/{characterLimits.characters}
                  </p>
                </div>
                {errors.characters && (
                  <p className="mt-1 text-sm text-red-600 flex items-center">
            ...
            {generatedPlot ? (
              <>
                <div className="bg-gray-100 p-4 rounded-md mb-4 max-h-96 overflow-y-auto">
                  <p className="whitespace-pre-wrap">{generatedPlot}</p>
                </div>
              ...
              <p className="text-gray-500 italic">Your generated plot will appear here.</p>
            )}
          </CardContent>
        </Card>
      </div>
