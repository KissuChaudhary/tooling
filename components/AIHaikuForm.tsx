...
export default function HaikuGenerator() {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText(generatedHaiku);
    setCopied(true);
    ...
    <div className="max-w-7xl mx-auto p-4 mt-10">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        <Card className="w-full md:w-1/2">
          <CardHeader>
            <CardTitle>Haiku Theme</CardTitle>
          </CardHeader>
          <CardContent>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder="Enter the theme for your haiku..."
                    className={errors.theme ? 'border-red-500' : ''}
                  />
                  <p className={`absolute right-0 -bottom-5 text-xs ${characterCount === characterLimit ? 'text-orange-500' : 'text-gray-500'}`}>
        ...
        <Card className="w-full md:w-1/2">
          <CardHeader>
            <CardTitle>Generated Haiku</CardTitle>
          </CardHeader>
          <CardContent>
            {generatedHaiku ? (
              <>
                <div className="bg-gray-100 p-4 rounded-md mb-4 max-h-96 overflow-y-auto">
                  <p className="whitespace-pre-wrap text-center font-serif text-lg">{generatedHaiku}</p>
                </div>
              ...
              <p className="text-gray-500 italic">Your generated haiku will appear here.</p>
            )}
          </CardContent>
        </Card>
      </div>
