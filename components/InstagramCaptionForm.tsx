...
const moodOptions = ['Excited', 'Inspirational', 'Funny', 'Serious', 'Relaxed', 'Nostalgic'];
                ...
                <div key={field} className="relative">
                  <div className="flex justify-between items-center mb-1">
                    <Label htmlFor={field} className="text-sm font-medium text-gray-400 capitalize">
                      {field === 'callToAction' ? 'Call to Action' : field}
                    </Label>
                  ...
                  {field === 'mood' ? (
                    ...
                    <Textarea
                      ...
                      placeholder={`Enter ${field === 'callToAction' ? 'call to action' : field}...`}
