...
export default function UsernameGenerator() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 mt-10">
      <h1 className="text-4xl font-extrabold mb-8 text-center tracking-tight">AI Username Generator</h1>
      <p className="text-xl text-center mb-12 max-w-3xl mx-auto">Generate unique and creative usernames based on your interests and style preferences.</p>
