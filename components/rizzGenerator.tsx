...
const styleOptions = ['Smooth', 'Cheesy', 'Nerdy', 'Romantic', 'Funny', 'Confident'];
const intensityOptions = ['Mild', 'Moderate', 'Spicy', 'Extra Spicy'];
...
export default function AIRizzGenerator() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 mt-10">
      ...
      <p className="text-xl text-center mb-12 max-w-3xl mx-auto">Create Smooth Pickup Lines with Saze AI – Tailored, Catchy, and Instantly Shareable.</p>
      <AdUnit 
      ...
      <div className="flex flex-col md:flex-row gap-8">
        <Card className="w-full md:w-1/2">
          <CardHeader>
            <CardTitle>Rizz Details</CardTitle>
          </CardHeader>
          <CardContent>
            ...
            {generatedRizz ? (
              <>
                <div className="bg-gray-100 p-4 rounded-md mb-4">
                  <p className="whitespace-pre-wrap">{generatedRizz}</p>
                </div>
