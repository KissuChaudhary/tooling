...
const toneOptions = ['Professional', 'Casual', 'Academic', 'Persuasive', 'Informative']
const essayTypeOptions = ['Argumentative', 'Expository', 'Narrative', 'Descriptive', 'Compare and Contrast']
const audienceOptions = ['Students', 'Professionals', 'General Public', 'Academics', 'Children']
const lengthOptions = ['Small (100 words)', 'Medium (150 words)', 'Long (200 words)']
const purposeOptions = ['Inform', 'Inspire', 'Persuade', 'Entertain', 'Analyze']
    ...
    <div className="max-w-7xl mx-auto mt-10">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        <Card className="w-full md:w-1/2">
          <CardHeader>
            <CardTitle>Essay Parameters</CardTitle>
          </CardHeader>
          <CardContent>
                ...
                <div key={field} className="relative">
                  ...
                  {field === 'topic' ? (
                    ...
                    <Select onValueChange={(value) => handleChange(field, value)}>
                      ...
                      <SelectContent>
                        {(field === 'tone' ? toneOptions :
                          field === 'essayType' ? essayTypeOptions :
                          field === 'audience' ? audienceOptions :
                          field === 'length' ? lengthOptions :
