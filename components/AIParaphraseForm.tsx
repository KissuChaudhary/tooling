...
export default function ParaphrasingTool() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.error || 'An error occurred while paraphrasing the text');
      }
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 mt-10">
      <h1 className="text-4xl font-extrabold mb-8 text-center tracking-tight">AI Paraphrasing Tool</h1>
      <p className="text-xl text-center mb-12 max-w-3xl mx-auto">Rewrite Your Text with Saze AI – Enhance Your Writing in Various Styles.</p>
      <AdUnit 
      ...
      <div className="flex flex-col md:flex-row gap-8">
        <Card className="w-full md:w-1/2">
          <CardHeader>
            <CardTitle>Paraphrasing Parameters</CardTitle>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Textarea
                    ...
                    className={`resize-none h-40 ${errors.text ? 'border-red-500' : ''}`}
                  />
              ...
              <div className="space-y-2">
                ...
                <Select onValueChange={handleStyleChange} defaultValue={formData.style}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="smarter">Smarter</SelectItem>
        ...
        <Card className="w-full md:w-1/2">
          ...
          <CardContent>
            {paraphrasedText ? (
              ...
              <p className="text-gray-500 italic">Your paraphrased text will appear here.</p>
            )}
          </CardContent>
        </Card>
      </div>
