...
export default function MetaphorGenerator() {
  ...
  const [generatedMetaphor, setGeneratedMetaphor] = useState<string>('');
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText(generatedMetaphor);
    setCopied(true);
    ...
    <div className="max-w-7xl mx-auto p-4 mt-10">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        <Card className="w-full md:w-1/2">
          <CardHeader>
            <CardTitle>Metaphor Parameters</CardTitle>
          </CardHeader>
          <CardContent>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder="Enter the topic for your metaphor..."
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Textarea
                    ...
                    placeholder="Provide context or additional details for the metaphor..."
                    className={`resize-none ${errors.context ? 'border-red-500' : ''}`}
                    rows={4}
                  />
                  <p className={`absolute right-0 -bottom-5 text-xs ${parseInt(characterCounts.context) === characterLimits.context ? 'text-orange-500' : 'text-gray-500'}`}>
                    {characterCounts.context}/{characterLimits.context}
                  </p>
                </div>
                {errors.context && (
                  <p className="mt-1 text-sm text-red-600 flex items-center">
        ...
        <Card className="w-full md:w-1/2">
          <CardHeader>
            <CardTitle>Generated Metaphor</CardTitle>
          </CardHeader>
          <CardContent>
            {generatedMetaphor ? (
              <>
                <div className="bg-gray-100 p-4 rounded-md mb-4 max-h-96 overflow-y-auto">
                  <p className="whitespace-pre-wrap">{generatedMetaphor}</p>
                </div>
              ...
              <p className="text-gray-500 italic">Your generated metaphor will appear here.</p>
            )}
          </CardContent>
        </Card>
      </div>
