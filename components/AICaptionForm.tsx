...
export default function CaptionGenerator() {
  ...
  const handlePlatformChange = (value: 'Instagram' | 'Twitter' | 'Facebook' | 'LinkedIn') => {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.image.trim()) {
      newErrors.image = 'Image description is required';
    }
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 mt-10">
      <h1 className="text-4xl font-extrabold mb-8 text-center tracking-tight">AI Caption Generator</h1>
      <p className="text-xl text-center mb-12 max-w-3xl mx-auto">Create Engaging Captions for Your Social Media Posts with Saze AI.</p>
      <AdUnit 
      ...
      <div className="flex flex-col md:flex-row gap-8">
        <Card className="w-full md:w-1/2">
          <CardHeader>
            <CardTitle>Caption Parameters</CardTitle>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Textarea
                    ...
                    placeholder="Describe the image you want to caption..."
                    className={`resize-none h-32 ${errors.image ? 'border-red-500' : ''}`}
                  />
                  <p className={`absolute right-0 -bottom-5 text-xs ${parseInt(characterCounts.image) === characterLimits.image ? 'text-orange-500' : 'text-gray-500'}`}>
                    {characterCounts.image}/{characterLimits.image}
                  </p>
                </div>
                {errors.image && (
              ...
              <div className="space-y-2">
                ...
                <Select onValueChange={handlePlatformChange} defaultValue={formData.platform}>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder="Describe the desired tone (e.g., funny, professional, inspirational)..."
        ...
        <Card className="w-full md:w-1/2">
          ...
          <CardContent>
            {generatedCaption ? (
              <>
                <div className="bg-gray-100 p-4 rounded-md mb-4 max-h-48 overflow-y-auto">
              ...
              <p className="text-gray-500 italic">Your generated caption will appear here.</p>
            )}
          </CardContent>
        </Card>
      </div>
