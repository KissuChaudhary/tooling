...
export default function IntroductionWriter() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.error || 'An error occurred while generating the introduction');
      }
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText(generatedIntroduction);
    setCopied(true);
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 mt-10">
      <h1 className="text-4xl font-extrabold mb-8 text-center tracking-tight">AI Introduction Writer</h1>
      <p className="text-xl text-center mb-12 max-w-3xl mx-auto">Create Compelling Introductions with Saze AI – Captivate Your Audience from the Start.</p>
      <AdUnit 
      ...
      <div className="flex flex-col md:flex-row gap-8">
        <Card className="w-full md:w-1/2">
          <CardHeader>
            <CardTitle>Introduction Parameters</CardTitle>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder="Enter the main topic of your introduction..."
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  />
                  <p className={`absolute right-0 -bottom-5 text-xs ${parseInt(characterCounts.audience) === characterLimits.audience ? 'text-orange-500' : 'text-gray-500'}`}>
                    {characterCounts.audience}/{characterLimits.audience}
                  </p>
                </div>
                {errors.audience && (
                  <p className="mt-1 text-sm text-red-600 flex items-center">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder="Specify the desired tone (e.g., formal, friendly, persuasive)..."
            ...
            {generatedIntroduction ? (
              <>
                <div className="bg-gray-100 p-4 rounded-md mb-4 max-h-96 overflow-y-auto">
                  <p className="whitespace-pre-wrap">{generatedIntroduction}</p>
                </div>
              ...
              <p className="text-gray-500 italic">Your generated introduction will appear here.</p>
            )}
          </CardContent>
        </Card>
      </div>
