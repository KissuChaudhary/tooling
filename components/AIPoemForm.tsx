...
export default function PoemGenerator() {
  ...
  const handleChange = (name: keyof FormData, value: string) => {
    if (name === 'length' || value.length <= characterLimits[name as keyof typeof characterLimits]) {
...
/>
      ...
      <div className="flex flex-col md:flex-row gap-8">
        <Card className="w-full md:w-1/2">
          <CardHeader>
            <CardTitle>Poem Parameters</CardTitle>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder="Enter the theme for your poem..."
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder="Enter the style of the poem (e.g., sonnet, haiku, free verse)..."
                    className={errors.style ? 'border-red-500' : ''}
                  />
                  <p className={`absolute right-0 -bottom-5 text-xs ${parseInt(characterCounts.style) === characterLimits.style ? 'text-orange-500' : 'text-gray-500'}`}>
                    {characterCounts.style}/{characterLimits.style}
                  </p>
                </div>
                {errors.style && (
                  <p className="mt-1 text-sm text-red-600 flex items-center">
              ...
              <div className="space-y-2">
                ...
                <Select onValueChange={(value) => handleChange('length', value)}>
                  <SelectTrigger id="length" className={errors.length ? 'border-red-500' : ''}>
                    <SelectValue placeholder="Select poem length" />
                  </SelectTrigger>
                  <SelectContent>
        ...
        <Card className="w-full md:w-1/2">
          ...
          <CardContent>
            {generatedPoem ? (
              ...
              <p className="text-gray-500 italic">Your generated poem will appear here.</p>
            )}
          </CardContent>
        </Card>
      </div>
