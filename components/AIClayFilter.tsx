...
export default function ClayFaceTransform() {
    ...
    <div className="mx-auto p-2 min-h-screen">
      <Card className="w-full max-w-7xl mx-auto shadow">
        ...
        <CardHeader className="text-foreground">
          <CardTitle className="text-3xl font-bold text-center">Clay Face Transformer</CardTitle>
        </CardHeader>
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="w-full lg:w-1/2 space-y-6">
              ...
              <div className="flex space-x-4">
                ...
                >
                  {loading ? 'Processing...' : 'Apply Clay Filter'}
                </Button>
                <Button
                  onClick={handleReset}
