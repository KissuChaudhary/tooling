...
export default function Page() {
  return (
    <div className="bg-background text-foreground">
      ...
      {/* Tools Showcase */}
      <section id="tools" className="bg-muted py-20">
            ...
            {[
              ...
              <Card key={index} className="p-4 hover:shadow-lg transition-all cursor-pointer group">
                <CardContent className="flex flex-col items-center text-center">
                  <tool.icon className="h-10 w-10 mb-4 text-primary group-hover:text-primary-foreground transition-colors" />
                  <h3 className="font-semibold mb-2">{tool.name}</h3>
                  <Badge variant="secondary" className="group-hover:bg-primary-foreground group-hover:text-primary">AI-Powered</Badge>
                </CardContent>
              </Card>
            ))}
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={index} className="bg-primary-foreground/10 backdrop-blur-lg p-6">
                <CardContent>
